 ...
 * ------------------------------------------------------------------------
 * WordWrap    : A function to make text appear in a neat paragraph format
 *************************************************************************/
namespace globalPkmnConsts
{
	...
	inline string WordWrap(const string &SENTENCE,    //PROC - the sentence
			               const int    &LINE_WIDTH)  //PROC - the width of
													  //       each line
	{
	    std::istringstream words(SENTENCE); //PROC - the words in the sentence
...
class Pokemon //Base Class
{
	public:
		 ...
		 *   Return: none
		 ***************************************************************/
		void PrintAbility(std::ostream &fout) const;
